...
if (in_array($user['authlevel'], array(LEVEL_ADMIN, LEVEL_OPERATOR))) {
    ...
    if (isset($_POST['delit'])) {
        ...
        AdminMessage($lang['mlst_mess_del'] . " ( " . $_POST['delit'] . " )", $lang['mlst_title'], header('Refresh: 5; URL=admin.php?page=messagelist'));
    }
    Game::displayadmin($display, $lang['mlst_title'], false, '', true);
} else {
