...
function XNovaResetUnivers($CurrentUser) {
    ...
    if (in_array($CurrentUser['authlevel'], array(LEVEL_ADMIN))) {
        ...
        AdminMessage($TransUser . $lang['adm_rz_done'], $lang['adm_rz_ttle'], header('Refresh: 5; URL=admin.php?page=XNovaResetUnivers'));
    } else {
        AdminMessage($lang['sys_noalloaw'], $lang['sys_noaccess'], header('Refresh: 5; URL=admin.php?page=XNovaResetUnivers'));
    }
    return $Page;
}
