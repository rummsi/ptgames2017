...
//					$_POST['text'] = str_replace('\r\n', '<br />', $_POST['text']);
                ...
                if ($MessCategory == 100) {
                    ...
                    while ($CurMess = mysqli_fetch_array($UsrMess)) {
                        ...
                        if ($CurMess['message_type'] == 1) {
                            $page .= "<a href=\"game.php?page=messages&type=write&amp;id=" . $CurMess['message_sender'] . "&amp;subject=" . $lang['mess_answer_prefix'] . htmlspecialchars($CurMess['message_subject']) . "\">";
            ...
            default:
                ...
                $page .= "</tr>";
                $page .= "<tr>";
                $page .= "	<th colspan=\"3\"><a href=\"game.php?page=messages&type=show&amp;messcat=100\"><font color=\"" . $TitleColor[100] . "\">" . $lang['type'][100] . "</a></th>";
                ...
                for ($MessType = 0; $MessType < 100; $MessType++) {
                    if (in_array($MessType, $MessageType)) {
                        $page .= "<tr>";
                        $page .= "	<th colspan=\"3\"><a href=\"game.php?page=messages&type=show&amp;messcat=" . $MessType . " \"><font color=\"" . $TitleColor[$MessType] . "\">" . $lang['type'][$MessType] . "</a></th>";
