                            ...
                            <table>
                                <tr>
                                    ...
                                    <th style="background-color: transparent;">
                                        <select name="who" onChange="javascript:document.forms[0].submit()">{$who}</select>
                                    </th>
                                    <th style="background-color: transparent;">&nbsp;{$stat_by}&nbsp;</th>
                                    <th style="background-color: transparent;">
                                        <select name="type" onChange="javascript:document.forms[0].submit()">{$type}</select>
                                    </th>
                                    <th style="background-color: transparent;">&nbsp;{$stat_range}&nbsp;</th>
                                    <th style="background-color: transparent;">
                                        <select name="range" onChange="javascript:document.forms[0].submit()">{$range}</select>
                                    </th>
                                    <th width="8%" style="background-color: transparent;">&nbsp;</th>
                                <tr>
                            </table>
