            ...
            <form action="game.php?page=messages&type=write&id={$id}" method="post">
                <table width="519">
                    ...
                    <tr>
                        ...
                        <th colspan="2"><input type="submit" value="{$lang['mess_envoyer']}" size="20" style="font-weight:bold" onClick="this.form.submit();this.disabled=true;this.value='Patientez...'"/></th>
                    </tr><tr>
