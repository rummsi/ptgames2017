...
{block name="content"}        <center>
            <br>
            <table width="600">
                <tr><td class="c" colspan="10" align="center"><b><font color="white">Ajouter une Annonce</font></b></td></tr>
                <tr><td class="c" colspan="10" align="center"><b>Ressources &agrave; Vendre</font></b></td></tr>
                <form action="game.php?page=annonce&action=5" method="post">
                    ...
                    <tr><td class="c" colspan="10" align="center"><b>Ressources Souhait&eacute;es</font></b></td></tr>
