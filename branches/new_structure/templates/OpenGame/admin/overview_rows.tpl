<tr>
	<th><a href="game.php?page=messages&mode=write&id={adm_ov_data_id}"><img src="{dpath}img/{adm_ov_data_pict}" alt="{adm_ov_altpm}" title="{adm_ov_wrtpm}" border="0"></a></th>
	...
	<th>{state_vacancy}</th>
	<th>{is_banned}</th>
		<th>[<a href="game.php?page=galaxy&mode=0&galaxy={usr_planet_gal}&system={usr_planet_sys}">{usr_planet_gal}:{usr_planet_sys}:{usr_planet_pos}</a>]</th>
			<th>{current_page}</th>
</tr>