            ...
            <table width="519">
                <tr>
                    <td class="c" colspan="4">
                        <a href="game.php?page=overview&action=renameplanet" title="{$Planet_menu}">{$Planet} "{$planet_name}"</a>
                        ({$user_username})
                    </td>
                </tr>
                {$Have_new_message}
                ...
                <tr>
                    <th>{$Diameter}</th>
                    <th colspan="3">{$planet_diameter} km (
                        <a title="{$Developed_fields}">{$planet_field_current}</a> / 
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" width="50%" style="background-color: transparent;">
                                        <b>{$ov_off_mines} : {$xpminier} / {$lvl_up_minier}</b>
                                    </td>
                                    <td align="center" width="50%" style="background-color: transparent;">
                                        <b>{$ov_off_raids} : {$xpraid} / {$lvl_up_raid}</b>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <th>{$Position}</th>
                    <th colspan="3">
                        <a href="game.php?page=galaxy&mode=0&galaxy={$galaxy_galaxy}&system={$galaxy_system}">
