 ...
 * @ShowPaneladminaPage.php
 * @license http://www.gnu.org/licenses/gpl.html GNU GPLv3 License
 * @version 0.01  15/abr/2016 21:30:42
 */

/**
 * Description of ShowPaneladminaPage
 *
 * @author author XNovaPT Team <xnovaptteam@gmail.com>
 */
class ShowPaneladminaPage extends AbstractAdminPage {

    function __construct() {
        parent::__construct();
        $this->tplObj->compile_id = 'paneladmina';
    }
                ...
                switch ($_GET['result']) {
                    ...
                    case 'usr_level':
                        if (!isset($_GET['s']) || !isset($_SESSION['CSRF']) || $_GET['s'] !== $_SESSION['CSRF']) {
                            AdminMessage(
                                    'One have tried to overcome administration privilleges.', 'Hacking attempt');
                            break;
                        }
