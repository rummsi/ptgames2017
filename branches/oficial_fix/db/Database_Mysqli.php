 ...
 * @version 0.01  5/abr/2015 11:36:35
 */

/**
 * Description of Database_Mysqli
 *
...
class Database_Mysqli extends mysqli {
    ...
    public function __construct() {
        ...
        parent::__construct($config['global']['database']['options']['hostname'], $config['global']['database']['options']['username'], $config['global']['database']['options']['password'], $config['global']['database']['options']['database'], $database['port']);
        ...
        include dirname(dirname(__FILE__)) . '/db/dbtables.php';
      //  define('USERS', 'ptgamespt_users');
    }
