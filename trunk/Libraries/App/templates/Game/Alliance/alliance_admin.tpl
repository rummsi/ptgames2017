...
{block name="content"}
        <center>
            ...
            <form action="" method="POST">
                ...
                <table width=519>
                    ...
                    <tr>
                        ...
                        <th><a href="game.php?page=alliance&mode=admin&edit=ally&t=3">{$Show_of_request_text}</a></th>
                    </tr>
                    <tr>
            ...
            <form action="game.php?page=alliance&mode=admin&edit=exit" method="post">
                <table width="519">
                    <tr>
                        <td class="c" colspan="2">{$Disolve_alliance}</td>
                    </tr>
                    <tr>
                        <th colspan="2"><input type="submit" value="continuer"></th>
                    </tr>
                </table>
            </form>
            <form action="game.php?page=alliance&mode=admin&edit=give" method="post">
                <table width="519">
                    <tr>
                        <td class="c" colspan="2">{$Transfer_alliance}</td>
                    </tr>
                    <tr>
                        <th colspan="2"><input type="submit" value="continuer"></th>
                    </tr>
