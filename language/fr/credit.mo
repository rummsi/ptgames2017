...
$lang['cred_infotxt'] = 'La page de crédit n\'a pas vocation d\'être modifiée  car elle garantie votre droit d\'utiliser XNova pour votre propre serveur. Vous n\'avez donc pas la permission de changer ce qu\'elle contient par défaut. Cependant, grâce au système de copyright étendus, vous avez la possibilité d\'afficher votre nom en dessous des développeurs officiels et ainsi protéger vos innovations.';
