...
$lang['cookies']['Error1'] = 'Errore nei cookie, c\'è più di un utente con lo stesso nome !<a href=index.php>Login</a> eliminare i cookie. In caso di problemi contattare l\'admin';
