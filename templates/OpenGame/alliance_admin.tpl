...
<table width=519>
	...
	<tr>
	  <th colspan=2><a href="game.php?page=alliance&type=admin&edit=rights">{Law_settings}</a></th>
	</tr>
	<tr>
	  <th colspan=2><a href="game.php?page=alliance&type=admin&edit=members">{Members_administrate}</a></th>
	</tr>
	<tr>
	  <th colspan=2><a href="game.php?page=alliance&type=admin&edit=tag">{Change_the_ally_tag}</a></th>
	</tr>
	<!--<img src="{dpath}pic/appwiz.gif" border=0 alt="">-->
	<tr>
	  <th colspan=2><a href="game.php?page=alliance&type=admin&edit=name">{Change_the_ally_name}</a></th>
	</tr>
	<!--<img src="{dpath}pic/appwiz.gif" border=0 alt="">-->
</table>
<br>
...
<table width=519>
	...
	<tr>
	  <th><a href="game.php?page=alliance&type=admin&edit=ally&t=1">{External_text}</a></th>
	  <th><a href="game.php?page=alliance&type=admin&edit=ally&t=2">{Internal_text}</a></th>
	</tr>
	<tr>
